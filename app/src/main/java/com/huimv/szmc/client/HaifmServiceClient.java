...
public class HaifmServiceClient {
    private String nullStr = "[]";
	public ResultSet HaifmService(Map<String, String> parmasMap, Context context)
			throws Exception {
		ResultSet rs = new ResultSet();;
		String namespace = ""; // 使用公司的命名空间，可为空
		String url = "http://" + XtAppConstant.SERVICE_IP
				+ "/ifm/services/HmHaifmService";
		String methodName = "HaifmService"; // 指定调用的服务名
